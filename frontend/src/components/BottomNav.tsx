...
import { Home, Sparkles, Siren, Heart, User } from 'lucide-react';
    ...
    >
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto flex items-center justify-around">
        ...
        <button
          ...
          aria-label="Home Tab"
        >
          <Home size={22} className="stroke-[2] sm:w-6 sm:h-6" />
        ...
        >
          <Sparkles size={22} className="stroke-[2] sm:w-6 sm:h-6" />
          <span className="text-[10px] sm:text-xs font-bold">TrahiGPT</span>
        </button>

        {/* 3. SOS Tab (Center Elevated Beacon) */}
        <div className="flex flex-col items-center -mt-9 sm:-mt-11">
          <button
            id="nav-tab-sos"
            onClick={() => onTabChange('sos')}
            className={`w-14 h-14 sm:w-16 sm:h-16 bg-[#0F9D8F] hover:bg-[#0c8579] rounded-2xl shadow-lg shadow-[#0F9D8F]/30 flex items-center justify-center mb-1 border-4 border-white active:scale-95 transition-all cursor-pointer ${
              activeTab === 'sos' ? 'scale-105 shadow-[#0F9D8F]/40' : 'opacity-90'
            }`}
            aria-label="SOS Emergency Mode"
          >
            <Siren size={26} className="text-white stroke-[2.2] sm:w-7 sm:h-7" />
          </button>
          <span className="text-[10px] sm:text-xs font-bold text-[#0F9D8F]">SOS</span>
        </div>
        ...
        >
          <Heart size={22} className="stroke-[2] sm:w-6 sm:h-6" />
        ...
        >
          <User size={22} className="stroke-[2] sm:w-6 sm:h-6" />
